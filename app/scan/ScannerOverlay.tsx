  ...
  return (
    <div className="absolute inset-0 flex items-center justify-center pointer-events-none">
      <div className={cn(
        ...
        step === "barcode" ? "w-80 h-48" : "w-72 h-32"
      )}>
        {/* Main Thin Frame */}
        <div className="absolute inset-0 border border-white/30 rounded-3xl" />
        
        {/* Accentuated Corners for Visibility */}
        <div className="absolute top-0 left-0 w-8 h-8 border-t-2 border-l-2 border-emerald-500 rounded-tl-3xl" />
        <div className="absolute top-0 right-0 w-8 h-8 border-t-2 border-r-2 border-emerald-500 rounded-tr-3xl" />
        <div className="absolute bottom-0 left-0 w-8 h-8 border-b-2 border-l-2 border-emerald-500 rounded-bl-3xl" />
